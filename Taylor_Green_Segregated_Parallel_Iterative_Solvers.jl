...
global dt
  ...
  merge!(params, Dict(:h=>h,:dΩ=>dΩ, :ν=> ν,:u_adv=>u_adv,:θ=> 1))

  inv_lump_vel_mass!(Mat_inv_ML,Mat_ML)

  #Vectors initialization

  vec_App, vec_Apu, vec_Aup, vec_Auu = define_vectors(0.0, V, Q, P, U)
...
#solver settings
  ...
  for tn in time_step
    ...
    while m<=M
        ...
        # vec_Au = GridapDistributed.change_ghost(vec_Au, Mat_Auu.cols)
    ...
    @time vec_App, vec_Apu, vec_Aup, vec_Auu = define_vectors(tn, V, Q, P, U)
